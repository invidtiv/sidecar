...
The worktree plugin supports mouse interactions for list selection, scrolling, pane focus, and drag-to-resize. Follow the patterns in `internal/mouse` and `docs/deprecated/guides/ui-feature-guide.md`.
