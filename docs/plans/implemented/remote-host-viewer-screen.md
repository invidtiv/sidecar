...
- **2026-09-01** — Related: [Remote destinations in `@` and `W`](../active/remote-project-switcher.md) slices 0–2 bind `ScopeProject`+`HostID`. Slice 3 of that plan extends this announcement from Sessions-only to the bound project workspace.
