...
- [Hosting Herdr plugins in Sidecar](../deprecated/herdr-plugin-support.md) is deprecated, superseded by [the plugin ecosystem plan](plugin-ecosystem/README.md), and orthogonal. A plugin may eventually call the same agent-control core, but plugin hosting is not part of this plan.
