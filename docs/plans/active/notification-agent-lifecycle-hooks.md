...
**Status:** active; Phase A implemented on 2026-08-30, Phase B in progress, Phase C onward planned. M6 of [Notification sounds and native delivery](notification-sounds-and-native-delivery.md) **Tracking:** `td-43a93f` (Phase B: `td-b5a467`) **Created:** 2026-08-30 **Updated:** 2026-08-30 **Evidence baseline:** Sidecar `main` at `48ddd720`; OpenCode 1.18.23 and 1.18.25, Codex 0.151.0, Claude Code 2.1.220, Pi 0.84.3 surveyed, OpenCode traced including cancellation. Herdr `4a3b04f59ba3b7d8a15cea187b23e1e80c343b0c` inspected for comparison.
