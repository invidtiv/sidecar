...
- [pane-repositioning.md](pane-repositioning.md) moves leaves with their `termpanes.Deck` state intact. Tabs ride the leaf, so a repositioned shell leaf carries its whole tab set; M4 verifies this against the graft replay paths.
