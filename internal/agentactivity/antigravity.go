...
var antigravityRules = []Rule{
	{ID: "antigravity.screen.blocked", State: StateBlocked, Region: RegionLastLines, LastN: 24, Regexp: regexp.MustCompile(`(?im)(requesting permission for:|Do you trust the contents of this project\?|Yes, I trust this folder|Proceed|Amend|enter.*Confirm)`)},
	...
	{ID: "antigravity.screen.working", State: StateWorking, Region: RegionLastLines, LastN: 16, Regexp: regexp.MustCompile(`(?im)(Generating\.\.\.|esc to cancel|background tasks?:\s*[1-9]|[⠋⠙⠹⠸⠼⠴⠦⠧⠇⠏].*(?:ing|running|working))`)},
}
