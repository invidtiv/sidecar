...
var claudeRules = []Rule{
	{ID: "claude.screen.blocked", State: StateBlocked, Region: RegionScreen, Regexp: regexp.MustCompile(`(?im)(Do you want to proceed\?|Allow .*\?|Yes, allow|Yes, and don't ask again|Enter to (?:confirm|select).*Esc to cancel|↑/↓ to navigate)`)},
