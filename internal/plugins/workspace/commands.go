...
func (p *Plugin) Commands() []plugin.Command {
	...
	if p.viewMode == ViewModeList && p.docFocused() {
		cmds := []plugin.Command{
			...
			{ID: "edit-external", Name: "Editor", Description: "Open this file in the external editor", Context: "workspace-doc", Priority: 5},
			{ID: "reload", Name: "Reload", Description: "Reload this file from disk", Context: "workspace-doc", Priority: 6},
			{ID: "find-file", Name: "Find", Description: "Find a file by name in this pane", Context: "workspace-doc", Priority: 7},
			{ID: "search-project", Name: "Search", Description: "Search the project in this pane", Context: "workspace-doc", Priority: 8},
		...
		cmds = append(cmds,
			...
			plugin.Command{ID: "yank-contents", Name: "Yank", Description: "Copy file contents", Context: "workspace-doc", Priority: 16},
			plugin.Command{ID: "resize-pane-grow", Name: "Grow", Description: "Grow document pane", Context: "workspace-doc", Priority: 17},
			plugin.Command{ID: "resize-pane-shrink", Name: "Shrink", Description: "Shrink document pane", Context: "workspace-doc", Priority: 18},
...
func (p *Plugin) FocusContext() string {
	...
	default:
		...
		// A live editor in a focused document leaf is the same kind of context
		// the embedded terminal is: every key is on its way to vim, ctrl+c
		// included, so the app forwards them all (internal/app/update.go).
		if p.docEditActive() {
			return "workspace-doc-edit"
		}
