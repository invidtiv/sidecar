...
func TestHelpDispatches(t *testing.T) {
	for _, tt := range []struct {
		...
		{"shell list help", []string{"help", "shell", "list"}, 0, "Usage: sidecar shell list"},
		{"shell forget help", []string{"shell", "forget", "--help"}, 0, "Usage: sidecar shell forget"},
		{"shell restore help", []string{"help", "shell", "restore"}, 0, "Usage: sidecar shell restore"},
